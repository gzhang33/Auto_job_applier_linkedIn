...
username = "gzhang1819298200@gmail.com"       # Enter your username in the quotes
password = "Zzk1819298200."           # Enter your password in the quotes
...
llm_api_key = "sk-3ae94cf81a994759b9f3fd3a7ec805fe"              # Enter your DeepSeek API key in the quotes, make sure it's valid, if not will result in error.
'''
