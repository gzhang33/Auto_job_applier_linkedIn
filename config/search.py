...
search_terms = ["Full Stack Developer", "Embedded Engineer", "Project Manager", "AI Engineer", "Software Engineer", "IoT Engineer", "Software Developer", "Hardware Engineer", "AI Engineer"]

# Search location, this will be filled in "City, state, or zip code" search box. If left empty as "", tool will not fill it.
search_location = "Sheffield, United Kingdom"               # Some valid examples: "", "United States", "India", "Chicago, Illinois, United States", "90001, Los Angeles, California, United States", "Bengaluru, Karnataka, India", etc.
...
salary = "£20,000+"                        # "$40,000+", "$60,000+", "$80,000+", "$100,000+", "$120,000+", "$140,000+", "$160,000+", "$180,000+", "$200,000+"
...
bad_words = [".NET", "Ruby", "CNC", "UK citizen"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
