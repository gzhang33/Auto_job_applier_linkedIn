...
search_terms = ["Graduate Embedded Engineer", "Junior Full-Stack Developer", "IoT Engineer", "Web Developer", "Software Engineer", "Associate Product Manager", "Product Engineer"]
